...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>bootstrap/ui-bootstrap-0.3.0.min.js at gh-pages · angular-ui/bootstrap · GitHub</title>
...
<meta content="Bt4eCOoekdViVWZUnvv5eP18xB5zoTLvVn5bnefQj2E=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-8ea4ea72d7b478cc437d5b2e6841998ad79f1396.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="826cbddbd868f774d2e661bb4f461de5">
        ...
        <link data-pjax-transient rel='permalink' href='/angular-ui/bootstrap/blob/ffa33a9e5b3216a2fac877342bb733cd51d151d2/ui-bootstrap-0.3.0.min.js'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2Fangular-ui%2Fbootstrap%2Fblob%2Fgh-pages%2Fui-bootstrap-0.3.0.min.js">Sign in</a>
    </div>
...
<ul class="pagehead-actions">
  ...
  <ul class="tabs">
    ...
    <li><a href="/angular-ui/bootstrap/pulls" class="js-selected-navigation-item " data-selected-links="repo_pulls /angular-ui/bootstrap/pulls">Pull Requests <span class='counter'>16</span></a></li>

      <li><a href="/angular-ui/bootstrap/issues" class="js-selected-navigation-item " data-selected-links="repo_issues /angular-ui/bootstrap/issues">Issues <span class='counter'>69</span></a></li>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/changelog/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="changelog" rel="nofollow" title="changelog">changelog</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/dropdown_refactor/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="dropdown_refactor" rel="nofollow" title="dropdown_refactor">dropdown_refactor</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/gh-pages/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="gh-pages" rel="nofollow" title="gh-pages">gh-pages</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/grunt-release/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="grunt-release" rel="nofollow" title="grunt-release">grunt-release</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/master/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/modal_location_fix/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="modal_location_fix" rel="nofollow" title="modal_location_fix">modal_location_fix</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/pr486/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="pr486" rel="nofollow" title="pr486">pr486</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/tabs_orientation/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="tabs_orientation" rel="nofollow" title="tabs_orientation">tabs_orientation</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/tabs-refactor/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="tabs-refactor" rel="nofollow" title="tabs-refactor">tabs-refactor</a>
                </div> <!-- /.select-menu-item -->
            </div>
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="tags">
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/0.3.0/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="0.3.0" rel="nofollow" title="0.3.0">0.3.0</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/0.2.0/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="0.2.0" rel="nofollow" title="0.2.0">0.2.0</a>
                </div> <!-- /.select-menu-item -->
                <div class="select-menu-item js-navigation-item ">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/angular-ui/bootstrap/blob/0.1.0/ui-bootstrap-0.3.0.min.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="0.1.0" rel="nofollow" title="0.1.0">0.1.0</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:5d3feb571a4c663b1d37d80bbe2a92fd -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:5d3feb571a4c663b1d37d80bbe2a92fd -->
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/angular-ui/bootstrap/blob/ffa33a9e5b3216a2fac877342bb733cd51d151d2/ui-bootstrap-0.3.0.min.js" data-title="bootstrap/ui-bootstrap-0.3.0.min.js at gh-pages · angular-ui/bootstrap · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/angular-ui/bootstrap/raw/gh-pages/ui-bootstrap-0.3.0.min.js" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/angular-ui/bootstrap/blame/gh-pages/ui-bootstrap-0.3.0.min.js" class="button minibutton ">Blame</a>
                  <a href="/angular-ui/bootstrap/commits/gh-pages/ui-bootstrap-0.3.0.min.js" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.04934' data-host='fe13'></span>
